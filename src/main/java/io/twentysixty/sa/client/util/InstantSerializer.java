...
public class InstantSerializer extends JsonSerializer<Instant> {
	...
	public void serialize(Instant arg0, JsonGenerator arg1, SerializerProvider arg2)
		...
		/*
		 * if (result.length()==24) { result = result.replace("Z", "000Z"); } else if (result.length()==25) { result =
		 * result.replace("Z", "00Z"); } else if (result.length()==26) { result = result.replace("Z", "0Z"); }
		 */
